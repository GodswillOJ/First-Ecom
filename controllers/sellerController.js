...
const sendVerifyMail = async(username, email, user_id)=> {
    try {
        ...
        const mailOptions = {
            ...
            html: '<p>Hii '+username+', please click here to <a href="https://godswillsecomshop.onrender.com/seller/verify?id='+ user_id +'">Verify</a> your mail</p>'
        }
...
const sendResetPasswordMail = async(username, email, token)=> {
    try {
        ...
        const mailOptions = {
            ...
            html: '<p>Hii '+username+', please click here to <a href="https://godswillsecomshop.onrender.com/seller/forget-password?token='+ token +'">Reset</a> your password</p>'
        }
        transporter.sendMail(mailOptions, function(error, info){
            if (error) {
                console.log(error)
